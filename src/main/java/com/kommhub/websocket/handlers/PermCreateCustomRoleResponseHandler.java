...
public class PermCreateCustomRoleResponseHandler implements InstallationInboundMessageHandler {

    private final Gson gson;
    private final PermissionProxyPendingRegistry registry;

    @Override
    public WsMessageType getType() { return WsMessageType.PERM_CREATE_CUSTOM_ROLE_RESPONSE; }
