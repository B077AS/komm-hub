...
public class PermGetServerResponseHandler implements InstallationInboundMessageHandler {

    private final Gson gson;
    private final PermissionProxyPendingRegistry registry;

    @Override
    public WsMessageType getType() { return WsMessageType.PERM_GET_SERVER_RESPONSE; }
