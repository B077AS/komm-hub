...
public class PermUpdateRoleResponseHandler implements InstallationInboundMessageHandler {

    private final Gson gson;
    private final PermissionProxyPendingRegistry registry;

    @Override
    public WsMessageType getType() { return WsMessageType.PERM_UPDATE_ROLE_RESPONSE; }
